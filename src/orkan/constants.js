...
export const SCHEMA_KEY_NAME = 'schema';
export const SCHEMA_SETTINGS_KEY_NAME = 'schemaSettings';
export const USERS_KEY_NAME = 'usersPermissions';
export const USER_REQUESTS_KEY_NAME = 'usersRequests';
export const MEDIA_KEY_NAME = 'media';
...
export const MEDIA_KEY = 'orkanMedia';
